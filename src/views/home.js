...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Korean Craziness</title>
        <meta property="og:title" content="Korean Craziness" />
      </Helmet>
      ...
      <div className="home-banner">
        ...
        />
        <div className="home-container2 container-col-layout">
          <h1 className="home-text">47 Meters Down</h1>
